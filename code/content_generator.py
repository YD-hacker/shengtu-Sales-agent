...
CASES = [
    {
        ...
        "current_job": "安全运维", "salary": 9500, "duration": "一个半月",
        "pain_type": "factory_worker",
        "quote": "在厂里干了8年，出来学了一个半月，现在坐办公室比以前轻松多了",
    },
    {
        "id": "case_002",
        "age": 25, "gender": "女", "previous_job": "收银员",
        "education": "统招本科", "city": "杭州", "direction": "大数据",
        "current_job": "数据分析师", "salary": 11000, "duration": "一个半月",
    ...
    },
    {
        ...
        "education": "统招大专", "city": "广州", "direction": "网安",
        "current_job": "渗透测试", "salary": 12000, "duration": "一个半月",
        "pain_type": "low_end_job",
    ...
    },
    {
        ...
        "current_job": "安全工程师", "salary": 15000, "duration": "一个半月",
        "pain_type": "factory_worker",
    ...
    },
    {
        ...
        "current_job": "大数据开发", "salary": 13000, "duration": "一个半月",
        "pain_type": "no_future",
        "quote": "毕业即失业，在家蹲了半年，来学了一个半月大数据，现在月薪13000",
    },
    {
        "id": "case_006",
        "age": 31, "gender": "男", "previous_job": "被裁员",
        "education": "统招本科", "city": "杭州", "direction": "网安",
        "current_job": "安全运维", "salary": 10000, "duration": "一个半月",
        "pain_type": "layoff",
        "quote": "被裁后焦虑了两个月，来学了一个半月网安，现在比以前还稳定",
    },
    {
        "id": "case_007",
        "age": 27, "gender": "男", "previous_job": "保安",
        "education": "统招大专", "city": "广州", "direction": "网安",
        "current_job": "安全服务", "salary": 9000, "duration": "一个半月",
        "pain_type": "low_end_job",
        "quote": "以前站岗一个月4000，现在做安全服务9000，还不用风吹日晒",
    },
    {
        "id": "case_008",
        "age": 26, "gender": "女", "previous_job": "客服",
        "education": "统招大专", "city": "杭州", "direction": "大数据",
        "current_job": "数据运营", "salary": 10000, "duration": "一个半月",
        "pain_type": "unwilling",
...
async def generate_personalized_empathy(state: dict, user_msg: str, pain_tag: str) -> str:
    ...
    try:
        ...
        system_prompt = f"""你是小范，26岁的IT人才服务顾问。用户表达了以下困境：
"{user_msg}"
