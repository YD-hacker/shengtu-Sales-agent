...
def _check_qualification(params):
    ...
    edu = params.get("education", "")
    age = params.get("age", "")
    qualified = check_qualification({"education": edu, "age": age})
...
def _get_case(params):
    ...
    return {
        "found": False,
        "default_case": "上个月有个30岁零基础的学员，4个月学完现在在网安岗位月薪9000+"
    }
...
def build_tool_prompt(user_msg, state, available_tools=None):
    ...
    prompt = f"""你是小苏的AI助手。用户说："{user_msg}"
